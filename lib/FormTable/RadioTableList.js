...
var _RadioTable = require('../StandardTable/hoc/RadioTable');

var _RadioTable2 = _interopRequireDefault(_RadioTable);
...
var FormTable = function (_Component) {
  ...
  FormTable.prototype.makeRequest = function makeRequest(params) {
    ...
    requestAction(params).then(function (result) {
      if (result.errorCode == 0) _this2.setState({ pageList: result.data });else _this2.setState({
        pageList: {
          currentPage: 1,
          list: [],
          totalCount: 0,
  ...
  FormTable.prototype.render = function render() {
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(_RadioTable2['default'], {
        columns: columns,
